...
export default function AgricultureSkillsPage() {
    ...
    const fetchSkills = useCallback(async () => {
        try {
            ...
            params.append("sector", "AGRICULTURE");
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                {skills.length > 0 && (
                    <Link
                        href="/dashboard/skills/add?sector=AGRICULTURE"
            ...
            <div className="bg-card rounded-2xl shadow-lg p-6 border-2 border-border">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        placeholder="Search agriculture skills..."
            ...
            {filteredSkills.length === 0 ? (
                <div className="bg-card rounded-2xl shadow-xl p-16 text-center border-2 border-dashed border-border">
                    <p className="text-muted-foreground mb-6 text-lg">
                        {searchTerm
                            ? "No agriculture skills found matching your search"
                            : "You haven't added any agriculture skills yet"}
                    </p>
                    <Link
                        href="/dashboard/skills/add?sector=AGRICULTURE"
                    ...
                    >
                        <Plus className="h-5 w-5" />
                        <span>Add Your First Agriculture Skill</span>
                    </Link>
                </div>
            ) : (
